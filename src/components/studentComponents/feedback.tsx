      ...
      <div className="space-y-6">
        {reviews.length > 0 ? (
          reviews?.slice(0,3).map((item) => (
            <div key={item.id} className="group border-b border-slate-50 dark:border-slate-800 last:border-0 pb-6 last:pb-0">
                    ...
                    <div className="flex items-center gap-1">
                      {[...Array(5)].map((_, i) => (
                        <Star
                          ...
                          className={cn(
                            "w-3 h-3",
                            i < item.rating ? "fill-yellow-400 text-yellow-400" : "text-slate-200 dark:text-slate-700"
                          )}
                        />
                      ))}
                    </div>
              ...
              <div className="bg-slate-50/50 dark:bg-slate-800/50 rounded-lg p-3 ml-13">
